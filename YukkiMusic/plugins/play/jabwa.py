...
@app.on_message(
     command(["𝗞𝗛𝗔𝗬𝗔𝗟","مبرمج"])
    & ~filters.edited
)
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/b98198d020919a792940e.jpg",
caption=f"""**ꔷ𝗗𝗘𝗩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗟𝗢𝗟**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton(
                    "تواصل ◍", url=f"https://t.me/K55DD"
                ),
                ],
                [
                    InlineKeyboardButton(
...
async def ahmad(client: Client, message: Message): 
  await message.reply_photo(
    photo="https://telegra.ph/file/4e4e5d9294df98ed1f233.jpg",
    caption=f"""**𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗧𝗛𝗘 𝗛𝗘𝗟𝗣 𝗦𝗢𝗨𝗥𝗖𝗘 𝗟𝗢𝗟 𝗠𝗨𝗦𝗜𝗖 ◍**
...
════════ ××× ════════""",
        ...
        [
            [
                InlineKeyboardButton(f"قناة السورس  ◍", url=f"https://t.me/K55DD"),
                ],[
                InlineKeyboardButton(f"◍ اضفني الي قناتك", url=f"https://t.me/LL0_BOT?startchannel=true"),
                ],[
                InlineKeyboardButton("◍ أضفني الى مجموعتك", url=f"https://t.me/LL0_BOT?startgroup=true"),
                ]
            ]
        ),
    )
